...
> **Stages 1–2 only.** Right now Hjemby generates procedural terrain (Stage 1)
> and a cardinal-aligned PLS-style section grid + downtown anchor (Stage 2) on
> top of that terrain. No streets, no parcels, no agents, no time yet. See
